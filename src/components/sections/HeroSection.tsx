...
import { Github, Linkedin, Twitter, Youtube, Download, Mail } from "lucide-react";
        ...
        <section className="flex flex-col items-center text-center space-y-6 max-w-2xl mx-auto">
            ...
            <motion.div variants={itemVariants} className="space-y-2">
                ...
                <div className="flex items-center justify-center space-x-6 pt-3 text-gray-900 dark:text-white">
                    <a aria-label="GitHub" className="hover:text-primary transition-colors" href="https://github.com/jakirhossen" target="_blank" rel="noopener noreferrer">
                        <Github className="w-6 h-6" />
                    </a>
                    <a aria-label="LinkedIn" className="hover:text-primary transition-colors" href="https://linkedin.com/in/jakirhossen" target="_blank" rel="noopener noreferrer">
                        <Linkedin className="w-6 h-6" />
                    </a>
                    <a aria-label="Twitter X" className="hover:text-primary transition-colors" href="https://twitter.com/jakirhossen" target="_blank" rel="noopener noreferrer">
                        <Twitter className="w-6 h-6" />
                    </a>
                    <a aria-label="YouTube" className="hover:text-primary transition-colors" href="https://youtube.com/@jakirhossen" target="_blank" rel="noopener noreferrer">
